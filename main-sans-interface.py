...
ALERT_THRESHOLD_FRAMES   = 12     # Nombre minimum de frames consécutives où un objet est détecté avant alerte
TAILGATE_THRESHOLD_METERS = 8.0  # Distance maximale estimée pour considérer que la voiture "colle" (mètres)
TAILGATE_FRAMES_REQUIRED  = 6    # Nombre de frames consécutives de proximité avant notification calmante
